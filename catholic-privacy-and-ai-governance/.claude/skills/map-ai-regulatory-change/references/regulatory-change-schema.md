...
ingests an external input (a pasted AI-specific regulatory or standards
development) and maps its impact against `references/frameworks/index.md`,
this project's own registry. `frameworks_considered` asks a different
...
- `title` (string, required) — a short, specific name for this
  development. Used to name the rendered report file.
