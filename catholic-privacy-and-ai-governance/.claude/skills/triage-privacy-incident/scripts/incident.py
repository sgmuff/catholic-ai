#!/usr/bin/env python3
"""Validates a privacy-incident triage JSON against this skill's bundled
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Validate and render a privacy-incident triage.")
