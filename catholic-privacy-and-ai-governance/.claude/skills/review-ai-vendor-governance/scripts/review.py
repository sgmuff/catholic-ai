#!/usr/bin/env python3
"""Validates an AI-vendor-review JSON against this skill's bundled
framework registry and baseline checklist, then renders it to Markdown.
The model does the judgment — what the vendor's documentation actually
shows, per baseline item, and the overall risk level; this script only
checks the judgment is internally consistent. See SKILL.md step 4.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Validate and render an AI vendor review.")
