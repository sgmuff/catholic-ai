...
Copy this whole directory to `projects/<track>/<project-name>/`, then:
...
4. Delete this README and fill in `projects/<track>/<project-name>/README.md` from [`docs/project-template/README.template.md`](../README.template.md) instead.
