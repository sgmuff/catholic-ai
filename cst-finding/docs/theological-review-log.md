...
## 2026-08-08 — personalism.yaml gains a scenario on AI-generated content substituting for human-made work
Decision by: project maintainer (sgmuff) — **unreviewed**.
Change: `principles/personalism.yaml` gained a fourth scenario, "Substituting AI-generated content where the human origin itself matters," prompted by a real assessment (bulletin art generation) whose personalism rating covered whether an AI use displaces a human worker but not whether the *recipient* of AI-generated content experiences a real loss distinct from that — "AI fatigue" and a preference for encountering genuine human creative work over a statistically-generated substitute, even when quality is comparable and no livelihood is at stake. Grounded in this file's existing imago Dei citations (Compendium §105-107; Magnifica Humanitas §48) already in `magisterial_citations` — no new citation was added.
Notes: this is squarely the kind of interpretive judgment call (is this a real value CST would recognize, not just a preference) that most needs an actual theologian's eye, precisely because no new primary-source citation could be added to ground it further without one. Flagged here for whoever eventually reviews this file's content.
