...
- [ ] Every generated report recommends review by the using parish's pastor or someone else there well versed in Catholic theology — no report presents itself as a final word
- [ ] `docs/theological-review-log.md` has at least one dated entry recording a substantive change to `principles/` or `rubric/`
